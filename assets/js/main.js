...
$(function () {
	...
	$("input,textarea").jqBootstrapValidation({
        ...
        submitSuccess: function($form, event) {
            ...
            $.ajax({
                url: "https://formspree.io/jasonm4130@gmail.com",
                method: "POST",
                data: {
                    name: name,
                    email: email,
...
//             center: new google.maps.LatLng(-27.469771, 153.025124), // New York
...
//             position: new google.maps.LatLng(-27.469771, 153.025124),
//             map: map,
//             title: 'Jason M Design'
//         });
//     }
	...
	function fadeIntro(scrollTopp) {
		...
		if (homeSection.length > 0) {
			...
			if (homeSection.hasClass('home-fade') && ($(scrollTopp).scrollTop() <= homeSHeight)) {
				...
				overlay.css('opacity', (0.3 + topScroll/homeSection.height() * .5));
